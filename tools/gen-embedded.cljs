#!/usr/bin/env nbb
;; Generate `src/kotoba/cofog/embedded.cljc` from
;; `resources/kotoba/cofog/registry.edn`.
;;
...
;; depended on by `cloud-itonami-cofog-*`, so it would have inherited exactly
;; that fault.
;;
...
(def edn-path "resources/kotoba/cofog/registry.edn")
(def out-path "src/kotoba/cofog/embedded.cljc")
